...
eprintf_colored__296_v0() {
    ...
    __AF_eprintf295_v0__34_5="$__AF_eprintf295_v0";
    echo "$__AF_eprintf295_v0__34_5" > /dev/null 2>&1
}
colored__297_v0() {
    local message=$1
    local color=$2
...
remove__298_v0() {
    ...
    __AMBER_ARRAY_17=("");
    eprintf__295_v0 "${__AF_join6_v0__48_13}" __AMBER_ARRAY_17[@];
    __AF_eprintf295_v0__48_5="$__AF_eprintf295_v0";
    echo "$__AF_eprintf295_v0__48_5" > /dev/null 2>&1
}
remove_line__299_v0() {
    local cnt=$1
    if [ $(echo ${cnt} '>=' 1 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
        for _ in $(seq 0 $(echo ${cnt} '-' 1 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//')); do
            __AMBER_ARRAY_18=("");
            eprintf__295_v0 "\e[2K\e[1A" __AMBER_ARRAY_18[@];
            __AF_eprintf295_v0__55_13="$__AF_eprintf295_v0";
            echo "$__AF_eprintf295_v0__55_13" > /dev/null 2>&1
done
fi
    __AMBER_ARRAY_19=("");
    eprintf__295_v0 "\e[9999D" __AMBER_ARRAY_19[@];
    __AF_eprintf295_v0__58_5="$__AF_eprintf295_v0";
    echo "$__AF_eprintf295_v0__58_5" > /dev/null 2>&1
}
remove_current_line__300_v0() {
    __AMBER_ARRAY_20=("");
    eprintf__295_v0 "\e[2K\e[9999D" __AMBER_ARRAY_20[@];
    __AF_eprintf295_v0__63_5="$__AF_eprintf295_v0";
    echo "$__AF_eprintf295_v0__63_5" > /dev/null 2>&1
}
new_line__302_v0() {
    local cnt=$1
    for i in $(seq 0 $(echo ${cnt} '-' 1 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//')); do
        ...
        eprintf__295_v0 "
" __AMBER_ARRAY_21[@];
        __AF_eprintf295_v0__75_9="$__AF_eprintf295_v0";
        echo "$__AF_eprintf295_v0__75_9" > /dev/null 2>&1
done
}
go_up__303_v0() {
    local cnt=$1
    __AMBER_ARRAY_22=("");
    eprintf__295_v0 "\e[${cnt}A" __AMBER_ARRAY_22[@];
    __AF_eprintf295_v0__81_5="$__AF_eprintf295_v0";
    echo "$__AF_eprintf295_v0__81_5" > /dev/null 2>&1
}
go_down__304_v0() {
    local cnt=$1
    __AMBER_ARRAY_23=("");
    eprintf__295_v0 "\e[${cnt}B" __AMBER_ARRAY_23[@];
    __AF_eprintf295_v0__86_5="$__AF_eprintf295_v0";
    echo "$__AF_eprintf295_v0__86_5" > /dev/null 2>&1
}
# move the cursor up or down `cnt` lines.
get_term_size__308_v0() {
    ...
    if [ $(echo "${#parts[@]}" '!=' 2 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
        ...
        __AF_get_term_size308_v0=("${__AMBER_ARRAY_25[@]}");
        return 0
fi
...
if [ $__AS != 0 ]; then
        ...
        __AF_get_term_size308_v0=("${__AMBER_ARRAY_26[@]}");
        return 0
fi;
    __AF_parse_number12_v0__114_16="$__AF_parse_number12_v0";
    local rows="$__AF_parse_number12_v0__114_16"
    parse_number__12_v0 "${parts[1]}";
    __AS=$?;
if [ $__AS != 0 ]; then
        __AMBER_ARRAY_27=(80 24);
        __AF_get_term_size308_v0=("${__AMBER_ARRAY_27[@]}");
        return 0
fi;
    __AF_parse_number12_v0__117_16="$__AF_parse_number12_v0";
    local cols="$__AF_parse_number12_v0__117_16"
    __AMBER_ARRAY_28=(${cols} ${rows});
    __AF_get_term_size308_v0=("${__AMBER_ARRAY_28[@]}");
    return 0
}
get_term_width__309_v0() {
    get_term_size__308_v0 ;
    __AF_get_term_size308_v0__125_16=("${__AF_get_term_size308_v0[@]}");
    local size=("${__AF_get_term_size308_v0__125_16[@]}")
...
do
            if [ $(echo ${iter} '>=' "${#items[@]}" | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
                ...
                __AF_eprintf_colored296_v0__167_27="$__AF_eprintf_colored296_v0";
                echo "$__AF_eprintf_colored296_v0__167_27" > /dev/null 2>&1
fi
            colored__297_v0 "${items[$(echo ${iter} '+' 1 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//')]}" 2;
            __AF_colored297_v0__169_41="${__AF_colored297_v0}";
            __AMBER_ARRAY_30=("");
            eprintf__295_v0 "${items[${iter}]}"" ""${__AF_colored297_v0__169_41}" __AMBER_ARRAY_30[@];
            __AF_eprintf295_v0__169_13="$__AF_eprintf295_v0";
            echo "$__AF_eprintf295_v0__169_13" > /dev/null 2>&1
...
do
            ...
            if [ $(echo  '!' ${first} | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
                eprintf_colored__296_v0 "${separator}" 90;
                __AF_eprintf_colored296_v0__195_17="$__AF_eprintf_colored296_v0";
                echo "$__AF_eprintf_colored296_v0__195_17" > /dev/null 2>&1
fi
            colored__297_v0 "${action}" 2;
            __AF_colored297_v0__197_33="${__AF_colored297_v0}";
            __AMBER_ARRAY_31=("");
            eprintf__295_v0 "${key}"" ""${__AF_colored297_v0__197_33}" __AMBER_ARRAY_31[@];
            __AF_eprintf295_v0__197_13="$__AF_eprintf295_v0";
            echo "$__AF_eprintf295_v0__197_13" > /dev/null 2>&1
...
eprintf_colored__475_v0() {
    ...
    eprintf__474_v0 "\x1b[${color}m%s\x1b[0m" __AMBER_ARRAY_41[@];
    __AF_eprintf474_v0__34_5="$__AF_eprintf474_v0";
    echo "$__AF_eprintf474_v0__34_5" > /dev/null 2>&1
}
colored__476_v0() {
    local message=$1
    local color=$2
...
remove_line__478_v0() {
    ...
    if [ $(echo ${cnt} '>=' 1 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
        for _ in $(seq 0 $(echo ${cnt} '-' 1 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//')); do
            __AMBER_ARRAY_42=("");
            eprintf__474_v0 "\e[2K\e[1A" __AMBER_ARRAY_42[@];
            __AF_eprintf474_v0__55_13="$__AF_eprintf474_v0";
            echo "$__AF_eprintf474_v0__55_13" > /dev/null 2>&1
done
fi
    __AMBER_ARRAY_43=("");
    eprintf__474_v0 "\e[9999D" __AMBER_ARRAY_43[@];
    __AF_eprintf474_v0__58_5="$__AF_eprintf474_v0";
    echo "$__AF_eprintf474_v0__58_5" > /dev/null 2>&1
}
remove_current_line__479_v0() {
    __AMBER_ARRAY_44=("");
    eprintf__474_v0 "\e[2K\e[9999D" __AMBER_ARRAY_44[@];
    __AF_eprintf474_v0__63_5="$__AF_eprintf474_v0";
    echo "$__AF_eprintf474_v0__63_5" > /dev/null 2>&1
}
print_blank__480_v0() {
    local cnt=$1
    # Prints blank spaces.
    for _ in $(seq 0 $(echo ${cnt} '-' 1 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//')); do
        __AMBER_ARRAY_45=("");
        eprintf__474_v0 " " __AMBER_ARRAY_45[@];
...
go_up__482_v0() {
    local cnt=$1
    __AMBER_ARRAY_47=("");
    eprintf__474_v0 "\e[${cnt}A" __AMBER_ARRAY_47[@];
    __AF_eprintf474_v0__81_5="$__AF_eprintf474_v0";
    echo "$__AF_eprintf474_v0__81_5" > /dev/null 2>&1
}
go_down__483_v0() {
    local cnt=$1
    __AMBER_ARRAY_48=("");
    eprintf__474_v0 "\e[${cnt}B" __AMBER_ARRAY_48[@];
    __AF_eprintf474_v0__86_5="$__AF_eprintf474_v0";
    echo "$__AF_eprintf474_v0__86_5" > /dev/null 2>&1
}
# move the cursor up or down `cnt` lines.
go_up_or_down__484_v0() {
    ...
    if [ $(echo ${cnt} '>' 0 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
        go_down__483_v0 ${cnt};
        __AF_go_down483_v0__92_9="$__AF_go_down483_v0";
        echo "$__AF_go_down483_v0__92_9" > /dev/null 2>&1
else
        go_up__482_v0 $(echo  '-' ${cnt} | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//');
        __AF_go_up482_v0__94_9="$__AF_go_up482_v0";
        echo "$__AF_go_up482_v0__94_9" > /dev/null 2>&1
fi
}
hide_cursor__485_v0() {
    __AMBER_ARRAY_49=("");
    eprintf__474_v0 "\e[?25l" __AMBER_ARRAY_49[@];
    __AF_eprintf474_v0__99_5="$__AF_eprintf474_v0";
    echo "$__AF_eprintf474_v0__99_5" > /dev/null 2>&1
}
show_cursor__486_v0() {
    __AMBER_ARRAY_50=("");
    eprintf__474_v0 "\e[?25h" __AMBER_ARRAY_50[@];
    __AF_eprintf474_v0__103_5="$__AF_eprintf474_v0";
    echo "$__AF_eprintf474_v0__103_5" > /dev/null 2>&1
}
get_term_size__487_v0() {
    ...
    if [ $(echo "${#parts[@]}" '!=' 2 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
        ...
        __AF_get_term_size487_v0=("${__AMBER_ARRAY_52[@]}");
        return 0
fi
    parse_number__12_v0 "${parts[0]}";
    __AS=$?;
if [ $__AS != 0 ]; then
        ...
        __AF_get_term_size487_v0=("${__AMBER_ARRAY_53[@]}");
        return 0
fi;
    __AF_parse_number12_v0__114_16="$__AF_parse_number12_v0";
    local rows="$__AF_parse_number12_v0__114_16"
...
if [ $__AS != 0 ]; then
        ...
        __AF_get_term_size487_v0=("${__AMBER_ARRAY_54[@]}");
        return 0
fi;
    __AF_parse_number12_v0__117_16="$__AF_parse_number12_v0";
    local cols="$__AF_parse_number12_v0__117_16"
    __AMBER_ARRAY_55=(${cols} ${rows});
    __AF_get_term_size487_v0=("${__AMBER_ARRAY_55[@]}");
    return 0
}
...
get_term_height__489_v0() {
    get_term_size__487_v0 ;
    __AF_get_term_size487_v0__131_16=("${__AF_get_term_size487_v0[@]}");
    local size=("${__AF_get_term_size487_v0__131_16[@]}")
...
do
            if [ $(echo ${iter} '>=' "${#items[@]}" | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
                ...
                __AF_eprintf_colored475_v0__167_27="$__AF_eprintf_colored475_v0";
                echo "$__AF_eprintf_colored475_v0__167_27" > /dev/null 2>&1
fi
            colored__476_v0 "${items[$(echo ${iter} '+' 1 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//')]}" 2;
            __AF_colored476_v0__169_41="${__AF_colored476_v0}";
            __AMBER_ARRAY_57=("");
            eprintf__474_v0 "${items[${iter}]}"" ""${__AF_colored476_v0__169_41}" __AMBER_ARRAY_57[@];
            __AF_eprintf474_v0__169_13="$__AF_eprintf474_v0";
            echo "$__AF_eprintf474_v0__169_13" > /dev/null 2>&1
            iter=$(echo ${iter} '+' 2 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//')
done
else
        # Slow path: truncate
...
do
            ...
            if [ $(echo  '!' ${first} | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
                eprintf_colored__475_v0 "${separator}" 90;
                __AF_eprintf_colored475_v0__195_17="$__AF_eprintf_colored475_v0";
                echo "$__AF_eprintf_colored475_v0__195_17" > /dev/null 2>&1
fi
            colored__476_v0 "${action}" 2;
            __AF_colored476_v0__197_33="${__AF_colored476_v0}";
            __AMBER_ARRAY_58=("");
            eprintf__474_v0 "${key}"" ""${__AF_colored476_v0__197_33}" __AMBER_ARRAY_58[@];
            __AF_eprintf474_v0__197_13="$__AF_eprintf474_v0";
            echo "$__AF_eprintf474_v0__197_13" > /dev/null 2>&1
            current_len=$(echo ${current_len} '+' ${needed} | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//')
            first=0
            iter=$(echo ${iter} '+' 2 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//')
done
...
render_page_indicator__516_v0() {
    ...
    if [ $(echo ${total_pages} '>' 1 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
        __AMBER_ARRAY_65=("");
        eprintf__474_v0 "\e[9999D\e[K" __AMBER_ARRAY_65[@];
        __AF_eprintf474_v0__75_9="$__AF_eprintf474_v0";
        echo "$__AF_eprintf474_v0__75_9" > /dev/null 2>&1
...
" __AMBER_ARRAY_67[@];
    ...
    __AMBER_ARRAY_68=("");
    eprintf__474_v0 "\e[9999D" __AMBER_ARRAY_68[@];
    ...
    if [ $(echo ${total_pages} '>' 1 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
        ...
        render_tooltip__491_v0 __AMBER_ARRAY_69[@] 36 ${term_width};
        ...
        render_tooltip__491_v0 __AMBER_ARRAY_70[@] 25 ${term_width};
...
do
        ...
        if [ $(echo ${prev_page} '!=' ${current_page} | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
            ...
            __AMBER_ARRAY_72=("");
            eprintf__474_v0 "\e[9999D" __AMBER_ARRAY_72[@];
            __AF_eprintf474_v0__204_17="$__AF_eprintf474_v0";
            echo "$__AF_eprintf474_v0__204_17" > /dev/null 2>&1
            render_choose_page__514_v0 options[@] ${current_page} ${selected} "${cursor}" ${page_size} ${display_count} ${term_width};
            __AF_render_choose_page514_v0__205_17="$__AF_render_choose_page514_v0";
            echo "$__AF_render_choose_page514_v0__205_17" > /dev/null 2>&1
            render_page_indicator__516_v0 ${current_page} ${total_pages};
            __AF_render_page_indicator516_v0__206_17="$__AF_render_page_indicator516_v0";
            echo "$__AF_render_page_indicator516_v0__206_17" > /dev/null 2>&1
            ...
            __AF_go_up482_v0__209_17="$__AF_go_up482_v0";
            echo "$__AF_go_up482_v0__209_17" > /dev/null 2>&1
            __AMBER_ARRAY_73=("");
            eprintf__474_v0 "\e[K" __AMBER_ARRAY_73[@];
            __AF_eprintf474_v0__210_17="$__AF_eprintf474_v0";
            echo "$__AF_eprintf474_v0__210_17" > /dev/null 2>&1
            __AMBER_LEN="${cursor}";
            print_blank__480_v0 "${#__AMBER_LEN}";
            __AF_print_blank480_v0__211_17="$__AF_print_blank480_v0";
            echo "$__AF_print_blank480_v0__211_17" > /dev/null 2>&1
            truncate_text__490_v0 "${page_options[${prev_selected}]}" ${max_option_width};
            __AF_truncate_text490_v0__212_25="${__AF_truncate_text490_v0}";
            __AMBER_ARRAY_74=("");
            eprintf__474_v0 "${__AF_truncate_text490_v0__212_25}" __AMBER_ARRAY_74[@];
            __AF_eprintf474_v0__212_17="$__AF_eprintf474_v0";
            echo "$__AF_eprintf474_v0__212_17" > /dev/null 2>&1
            local diff=$(echo ${selected} '-' ${prev_selected} | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//')
            go_up_or_down__484_v0 ${diff};
            __AF_go_up_or_down484_v0__215_17="$__AF_go_up_or_down484_v0";
            echo "$__AF_go_up_or_down484_v0__215_17" > /dev/null 2>&1
            __AMBER_ARRAY_75=("");
            eprintf__474_v0 "\e[9999D" __AMBER_ARRAY_75[@];
            __AF_eprintf474_v0__216_17="$__AF_eprintf474_v0";
            echo "$__AF_eprintf474_v0__216_17" > /dev/null 2>&1
            __AMBER_ARRAY_76=("");
            eprintf__474_v0 "\e[K" __AMBER_ARRAY_76[@];
            __AF_eprintf474_v0__217_17="$__AF_eprintf474_v0";
            echo "$__AF_eprintf474_v0__217_17" > /dev/null 2>&1
            get_page_options__512_v0 options[@] ${current_page} ${page_size};
            __AF_get_page_options512_v0__218_44=("${__AF_get_page_options512_v0[@]}");
            local current_page_options=("${__AF_get_page_options512_v0__218_44[@]}")
            truncate_text__490_v0 "${current_page_options[${selected}]}" ${max_option_width};
            __AF_truncate_text490_v0__219_42="${__AF_truncate_text490_v0}";
            eprintf_colored__475_v0 "${cursor}""${__AF_truncate_text490_v0__219_42}" 32;
            __AF_eprintf_colored475_v0__219_17="$__AF_eprintf_colored475_v0";
            echo "$__AF_eprintf_colored475_v0__219_17" > /dev/null 2>&1
            go_down__483_v0 $(echo ${display_count} '-' ${selected} | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//');
            __AF_go_down483_v0__221_17="$__AF_go_down483_v0";
            echo "$__AF_go_down483_v0__221_17" > /dev/null 2>&1
            __AMBER_ARRAY_77=("");
            eprintf__474_v0 "\e[9999D" __AMBER_ARRAY_77[@];
            __AF_eprintf474_v0__222_17="$__AF_eprintf474_v0";
...
eprintf_colored__678_v0() {
    ...
    eprintf__677_v0 "\x1b[${color}m%s\x1b[0m" __AMBER_ARRAY_106[@];
    __AF_eprintf677_v0__34_5="$__AF_eprintf677_v0";
    echo "$__AF_eprintf677_v0__34_5" > /dev/null 2>&1
}
colored__679_v0() {
    local message=$1
    local color=$2
...
remove_line__681_v0() {
    ...
    if [ $(echo ${cnt} '>=' 1 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
        for _ in $(seq 0 $(echo ${cnt} '-' 1 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//')); do
            __AMBER_ARRAY_107=("");
            eprintf__677_v0 "\e[2K\e[1A" __AMBER_ARRAY_107[@];
            __AF_eprintf677_v0__55_13="$__AF_eprintf677_v0";
            echo "$__AF_eprintf677_v0__55_13" > /dev/null 2>&1
done
fi
    __AMBER_ARRAY_108=("");
    eprintf__677_v0 "\e[9999D" __AMBER_ARRAY_108[@];
    __AF_eprintf677_v0__58_5="$__AF_eprintf677_v0";
    echo "$__AF_eprintf677_v0__58_5" > /dev/null 2>&1
}
remove_current_line__682_v0() {
    __AMBER_ARRAY_109=("");
    eprintf__677_v0 "\e[2K\e[9999D" __AMBER_ARRAY_109[@];
...
get_term_width__691_v0() {
    get_term_size__690_v0 ;
    __AF_get_term_size690_v0__125_16=("${__AF_get_term_size690_v0[@]}");
    local size=("${__AF_get_term_size690_v0__125_16[@]}")
...
do
            if [ $(echo ${iter} '>=' "${#items[@]}" | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
                ...
                __AF_eprintf_colored678_v0__167_27="$__AF_eprintf_colored678_v0";
                echo "$__AF_eprintf_colored678_v0__167_27" > /dev/null 2>&1
fi
...
do
            ...
            if [ $(echo  '!' ${first} | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
                eprintf_colored__678_v0 "${separator}" 90;
                __AF_eprintf_colored678_v0__195_17="$__AF_eprintf_colored678_v0";
                echo "$__AF_eprintf_colored678_v0__195_17" > /dev/null 2>&1
fi
